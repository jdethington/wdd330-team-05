...
import { getLocalStorage, formatCurrency, setLocalStorage, alertMessage, removeAllAlerts } from "./utils.mjs";
...
export default class CheckoutProcess {
    ...
    async checkout() {
        ...
        try {
            ...
            setLocalStorage("so-cart", []); // clear out local storage
            ...
            // if the error object contains specific field messages from the server:
            if (err.message && typeof err.message === "object") {
                ...
                alertMessage(err.message || "An error occurred with your order.");
            }
        }
    }
}
